...
resource "sumologic_http_source" "SIGNALS" {
  name                = "SIGNALS"
...
resource "sumologic_partition" "SIGNALS" {
  name = "SIGNALS"
            ...
            "layout": {
                ...
                "layoutStructures": [
                    ...
                    },
                    {
                        ...
                        "structure": "{\"height\":10,\"width\":14,\"x\":0,\"y\":56}"
                    },
                    {
            ...
            "panels": [
                {
                    ...
                    "linkedDashboards": [
                        {
                            "id": "Xn4TWQMAWlQKFgBZKD1dcDAMF1pBN6J4D9MUjto4vve97dCxmpwIp7fTKMAv",
                            "relativePath": "",
...
resource "sumologic_content" "simple_searches" {
    parent_id = data.sumologic_personal_folder.personalFolder.id
    config = jsonencode({
    "type": "FolderSyncDefinition",
    "name": "Simple Searches",
    "description": "",
    "children": [
        {
            "type": "SavedSearchWithScheduleSyncDefinition",
            "name": "CSE Forwarding Count",
            "search": {
                "queryText": "* | where _siemforward = \"true\" | count by _sourceCategory, _source | sort by _count",
        ...
        },
        {
            ...
            "name": "Signals Matrix",
            "search": {
                "queryText": "_index=SIGNALS _sourcecategory = \"asoc/SIGNAL/signals\"\n| json field=_raw \"content_type\" as category nodrop\n| json field=_raw \"asset.asset_type\" as asset_type nodrop\n| json field=_raw \"full_records[0].metadata_product\" as product nodrop\n| json field=_raw \"full_records[0].metadata_vendor\" as vendor nodrop\n| count by category, vendor, product, asset_type\n| sort by _count",
                "defaultTimeRange": "-60m",
                "byReceiptTime": false,
                "viewName": "",
                "viewStartTime": "1970-01-01T00:00:00Z",
        ...
        {
            "type": "SavedSearchWithScheduleSyncDefinition",
            "name": "Unparsed Records",
            "search": {
                "queryText": "_index=cse_records\n| json field=_raw \"metadata_product\" as product nodrop\n| json field=_raw \"metadata_deviceEventId\" as ID nodrop\n| json field=_raw \"metadata_sourceCategory\" as sourceCat nodrop\n| json field=_raw \"fields.reason\" as reason nodrop\n| json field=_raw \"parsed\" as parsing_status nodrop\n| where reason = \"failed_to_parse\" or parsing_status = \"false\" or reason = \"failed_to_map\"\n| count by product, reason, ID, sourceCat\n| sort by product\n",
                "defaultTimeRange": "-15m",
                "byReceiptTime": false,
                "viewName": "",
                "viewStartTime": "1970-01-01T00:00:00Z",
        ...
        {
            "type": "SavedSearchWithScheduleSyncDefinition",
            "name": "Unparsed Records with Raw",
            "search": {
                "queryText": "_sourceCategory=* AND !(_source=RECORDS OR _source=SIGNALS)\n[subquery:  _index=cse_records FailedRecord metadata_sourceMessageId\n            | json field=_raw \"metadata_sourceMessageId\" as _messageId nodrop\n            | limit 1000\n            | compose _messageId\n]\n| formatDate(_messageTime, \"yyyy-MM-dd HH:mm:ss\") as date\n| count as Total date, _sourceCategory, _raw\n| order by date\n| fields -Total",
                "defaultTimeRange": "-15m",
                "byReceiptTime": false,
                "viewName": "",
                "viewStartTime": "1970-01-01T00:00:00Z",
